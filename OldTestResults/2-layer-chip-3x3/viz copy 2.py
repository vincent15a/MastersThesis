...
def create_plot6(pairs, xlabel, ylabel, title: str):
    ...
    plt.figure(figsize=(10, 6))
    colors = ['b', 'g', 'r', 'm', 'y']
    labels = ["TATS-ND-FP", "RA-BC", "RA-BC No Horizontal Dissapation"]
    c_index = 0
    for x, y in pairs:
        plt.plot(x, y, '--', color=colors[c_index], label = labels[c_index])
        c_index += 1
...
create_plot6([(dfMILP['Nrtasks'], dfMILP['Time']), (dfMILP_RABC['Nrtasks'], dfMILP_RABC['Time']), (dfMILP_RABC_nohor['Nrtasks'], dfMILP_RABC_nohor['Time'])], 'Number of tasks', 'Time (s)', 'Running Time')
create_plot6([(dfMILP['Nrtasks'], dfMILP['Makespan']), (dfMILP_RABC['Nrtasks'], dfMILP_RABC['Makespan']), (dfMILP_RABC_nohor['Nrtasks'], dfMILP_RABC_nohor['Makespan'])], 'Number of tasks', 'Makespan', 'Makespan')
create_plot6([(dfMILP['Nrtasks'], dfMILP['MaxTemp']), (dfMILP_RABC['Nrtasks'], dfMILP_RABC['MaxTemp']), (dfMILP_RABC_nohor['Nrtasks'], dfMILP_RABC_nohor['MaxTemp'])], 'Number of tasks', 'Maximum Temperature (K)', 'Maximum Temperature')
